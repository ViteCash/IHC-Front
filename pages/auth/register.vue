      ...
      <UForm :state="formState" @submit="handleRegister">
        <!-- <div class="grid grid-cols-2 gap-4"> -->
          ...
          <UFormField label="Apellido" name="lastName" class="mb-4">
            <UInput v-model="formState.lastName" placeholder="Apellido" autocomplete="family-name" class="w-full" />
          </UFormField>
        <!-- </div> -->

        <UFormField label="Correo electrónico" name="email" class="mb-4">
          <UInput v-model="formState.email" type="email" placeholder="correo@ejemplo.com" autocomplete="email" class="w-full" />
        </UFormField>

        <UFormField label="Contraseña" name="password" class="mb-4">
          <UInput v-model="formState.password" type="password" placeholder="Contraseña (mínimo 6 caracteres)"
        ...
        <UFormField label="Tipo de cuenta" name="role" class="mb-4">
          <div class="flex gap-4 mt-2">
            <div class="flex items-center">
              <input id="alumno-radio" type="radio" v-model="formState.role" value="alumno"
                class="w-4 h-4 text-primary-600 focus:ring-primary-500" />
              <label for="alumno-radio" class="ml-2">Alumno</label>
            </div>
            <div class="flex items-center">
              <input id="profesor-radio" type="radio" v-model="formState.role" value="profesor"
                class="w-4 h-4 text-primary-600 focus:ring-primary-500" />
