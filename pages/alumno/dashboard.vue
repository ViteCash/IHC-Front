                    ...
                    <div class="flex justify-center mb-6 cursor-pointer">
                        <UAvatar
                            ...
                            :text="
                                ...
                                (userProfile?.last_name?.[0].toLowerCase() || '')
                            "
                            color="primary"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div v-else class="flex flew-row gap-4">
                                    <div
                                        ...
                                        :key="course.id"
                                        class="flex flex-col border border-gray-200 gap-1 p-4 hover:shadow-sm transition-shadow cursor-pointer rounded-lg"
                        ...
                        <UCard>
                            ...
                            <div class="p-4">
                                <p class="text-gray-500 mb-2">
                                    Ingresa el ID del curso al que deseas solicitar acceso:
                                </p>
                                <UInput
                                ...
                                <UButton
                                    ...
                                    @click="
                                        () =>
                                            console.log('Solicitar acceso al curso:', courseRequest)
                                    "
                                >
                                    Solicitar acceso
                                </UButton>
